...
if Third_Sea then
    ...
    spawn(function()
     ...
     local ToggleShark = Tabs.Main:AddToggle("ToggleShark", {Title = "Auto Kill Shark", Default = false })
    ...
    local ToggleFishCrew = Tabs.Main:AddToggle("ToggleFishCrew", {Title = "Auto Kill Fish Crew", Default = false })
...
Tabs.Setting:AddParagraph({
    ...
    Content = "Setting your distance for auto farm"
})
...
Tabs.Setting:AddParagraph({
    Title = "Setting Speed",
    Content = "Setting teleport/tween speed"
})
...
Tabs.Raid:AddParagraph({
    Title = "Raid Law",
    Content = "Auto buy and spawn boss law"
})
